...
export class CoursesService {
  ...
  courses2: CourseDisplayDto[] = [
      ...
      },
      {
        ...
        difficulty: 'Advanced',
        shortDescription: 'Prepare for the AWS Solutions Architect certification.',
        imageContents: '...'  // Base64 image contents
      },
      {
      ...
      },
      {
        ...
        difficulty: 'Intermediate',
        shortDescription: 'Learn to develop smart contracts on the Ethereum platform.',
        imageContents: '...'  // Base64 image contents
      },
      {
      ...
      },
      {
        ...
        difficulty: 'Advanced',
        shortDescription: 'Learn penetration testing and ethical hacking techniques.',
        imageContents: '...'  // Base64 image contents
      },
      {
        ...
        prerequisites: 'Basic IT Knowledge',
        difficulty: 'Intermediate',
        shortDescription: 'Learn containerization and orchestration with Docker and Kubernetes.',
        imageContents: '...'  // Base64 image contents
      },
      {
      ...
      },
      {
        ...
        difficulty: 'Advanced',
        shortDescription: 'Learn to process and analyze text data using NLP techniques.',
        imageContents: '...'  // Base64 image contents
      }, 
    {
      name: 'Angular',
